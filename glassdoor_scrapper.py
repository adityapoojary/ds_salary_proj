...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    url = "https://www.glassdoor.com/Job/jobs.htm?sc.keyword="+keyword+"&suggestCount=0&suggestChosen=false&clickSource=searchBox&locId=2940587&locT=C&locName=Bengaluru%20(India)"
    driver.get(url)
    jobs = []
